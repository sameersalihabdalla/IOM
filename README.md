...
|:---:|---|---|
| 1 | `screenshot/1.png` | **شاشة تسجيل الدخول:** واجهة المصادقة الآمنة لدخول النظام. |
| 2 | `screenshot/2.png` | **إدارة الوثائق والديون:** الجدول الرئيسي لعرض وثائق التأمين وحالات السداد ومتابعة المديونيات. |
| 3 | `screenshot/3.png` | **إضافة وثيقة جديدة:** إدخال بيانات المُؤمّن له، الفئة، والمبلغ الإجمالي. |
| 4 | `screenshot/4.png` | **رسالة التأكيد:** نافذة منبثقة تؤكد نجاح عملية الحفظ. |
| 5 | `screenshot/5.png` | **قائمة الوثائق المحدثة:** ظهور الوثيقة الجديدة بشكل فوري في النظام. |
| 6 | `screenshot/6.png` | **لوحة متابعة الأعمال:** المؤشرات العامة، إجمالي المبالغ، ونسب النمو. |
| 7 | `screenshot/7.png` | **الرسوم البيانية التحليلية:** توزيع الفئات الأكثر طلباً، الأداء اليومي والأسبوعي، وتوزيع الوثائق. |
| 8 | `screenshot/8.png` | **كشف وثائق الطرف الثالث:** تقرير تفصيلي لفترة محددة مع خيارات الطباعة. |
| 9 | `screenshot/9.png` | **تقرير وثائق اليوم (`report_today.php`):** أرقام الوثائق، الأقساط، والعمولات اليومية. |
| 10 | `screenshot/10.png` | **إدارة العملاء (`clients.php`):** إضافة وتعديل بيانات العملاء وأرقام الهواتف والحالة. |
| 11 | `screenshot/11.png` | **إدارة أنواع التأمين والفئات (`cat.php`):** إدارة الفئات، أقساط الركاب، التكلفة، وعمولات المكتب والوكيل. |
| 12 | `screenshot/12.png` | **نموذج إدخال الفئات:** واجهة إضافة وتعديل أسعار وتكاليف الفئات التأمينية. |
| 13 | `screenshot/13.png` | **كشف الحساب والرسائل (`send_sms.php`):** تفاصيل الحسابات، طباعة الفواتير، وإجماليات الطباعة والخدمات الأخرى. |
